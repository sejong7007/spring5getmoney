...
auth_vue = {
	...
	join_body: ()=>{
		...
		'          </div>'+
		'          <div class="col-md-6 mb-3">'+
		'            <label for="dupl-check">아이디 중복체크</label>'+
		'            <input type="text" class="form-control" id="dupl-check" placeholder="" value="" required="">'+
		'            <div class="invalid-feedback">'+
		...
		'        <div class="mb-3">'+
		'          <label for="address2">비밀번호 입력<span class="text-muted">(Optional)</span></label>'+
		'          <input type="password" class="form-control" id="password" placeholder="Apartment or suite">'+
		'        </div>'+
